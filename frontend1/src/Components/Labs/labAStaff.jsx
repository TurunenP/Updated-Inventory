    ...
    <div className="w-[95%] mx-auto my-8">
            ...
            <div className="mb-6 bg-green-700 h-full p-1">
              ...
              <div className="flex ">
                ...
                <div className="flex flex-col items-center ">
                  <h2>Trolley</h2>
                  <div className="bg-blue-700 m-3 py-16 px-6 rounded-md">
                    <Link
                      to="/Staff/labs/LabA/trolley"
                      className="bg-blue-300 text-gray-900 py-2 px-4 rounded-lg shadow-md text-center hover:bg-blue-400 transition"
                    >
                      View
                    </Link>
      ...
      <div className="flex justify-around gap-10 w-full">
        ...
        <div className="w-full border-blue-950 border-2 px-5 py-10 rounded-lg">
          <h2 className="text-xl text-white font-bold bg-blue-700 px-4 w-max rounded-lg py-4 mb-4">
            General Items
          </h2>
        </div>
      </div>
